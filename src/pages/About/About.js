        ...
        <div className="about-main">
            <div className='about-inner'>
                ...
                <div className='about-text'>
                    <p>My name is Long and I am a recent graduate of Per Scholas' Software Engineering bootcamp. I am skilled in HTML, CSS, Javascript, React, MongoDB, and Node. In the near future, I plan on expanding my knowledge and learning Java, Python , Springboot and other languages/frameworks.</p> <br/>
