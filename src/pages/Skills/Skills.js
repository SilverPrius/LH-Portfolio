    ...
    return (
        <div className="skills">
            ...
            <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" alt="The logo icon for JavaScript" title="JavaScriptt"/>  
                ...
                <Skill source="https://visualpharm.com/assets/115/Rest%20Api-595b40b65ba036ed117d3b7b.svg" alt="The logo icon for Bootstrap" title="Bootstrap"/>
                <Skill source="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg" alt="The logo icon for Restful API" title="Restful API"/>
